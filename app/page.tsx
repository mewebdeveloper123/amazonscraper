...
function HomePage() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <h1
        className="text-3xl text-center mt-2 text-black font-bold mb-5
        "
      >
        Welcome to the Amazon Scraper
      </h1>
      <h2 className="text-lg italic text-center text-black/50">
        Amazon Scraper is used the scrape data from amazon website full stack
        app of nextjs.
      </h2>
      <h3 className="text-lg text-center italic text-black/50">
        https://prowebunlimited.com
      </h3>
    </div>
  );
}
